...
public class MythicArmor implements SimpleFieldProcessingSubject<ArmorSet> {
    ...
    public static final ArmorSet CELESTIUM = new CelestiumArmorSet(MythicArmorMaterials.CELESTIUM, 41, settings -> settings.rarity(Rarity.RARE).fireResistant());
    ...
    public static final ArmorSet METALLURGIUM = new MetallurgiumArmorSet(MythicArmorMaterials.METALLURGIUM, 69, settings -> settings.fireResistant().rarity(Rarity.RARE));
    ...
    public static final ArmorSet PALLADIUM = new ArmorSet(MythicArmorMaterials.PALLADIUM, 28, Item.Properties::fireResistant);
