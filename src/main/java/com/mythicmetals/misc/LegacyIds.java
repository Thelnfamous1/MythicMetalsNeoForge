...
public class LegacyIds {
    private static final HashMap<ResourceLocation, ResourceLocation> LEGACY_IDS = new HashMap<>();
    ...
    public static HashMap<ResourceLocation, ResourceLocation> getLegacyIds() {
        createMap();
        return LEGACY_IDS;
    }
}
